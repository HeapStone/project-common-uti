...
public class GeneratorCodeUtil {
     ...
     * @param comCfgMap
     */
    private void checkProperty( Map<String,Object> comCfgMap ){
        ...
        Set<String> keys = comCfgMap.keySet();
            ...
            if(null == tempObj){
                logger.error("配置信息错误，未找到["+key+"]公共配置信息！");
                throw new RuntimeException("配置信息错误，未找到["+key+"]公共配置信息！");
            }
